# Tips for the Capstone

Information put together from various sources. Updated 2 November 2025. 
...
- Opening any files other than your cheatsheets and what is downloadable from the exam, and course websites.
...
4. File manager, e.g. Finder, Windows Explorer

5. PDF-viewers on your own computer, for viewing only.

6. Basic calculator on your computer.
...
9. Wikipedia pages below (ONLY the ones below are allowed):
...
- Certain Python IDEs and code editors on your computer, e.g. Visual Studio Code, Pycharm, Spyder, Jupyter Notebook, etc.
...
- The capstone exams are not as long as the in class finals on MIT OpenCourseWare but the types of questions/concepts are very similar.
